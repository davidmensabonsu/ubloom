          ...
          return (
            <NavLink
              ...
              <motion.div
                ...
                {item.isLogo ?
                <img alt="Home" className="<img alt="Home" className="h-[22px] w-[22px] object-contain" src="/lovable-uploads/74df1548-966b-4649-a7f6-0cd4b50572cf.png" /> object-contain" src="/lovable-uploads/74df1548-966b-4649-a7f6-0cd4b50572cf.png" /> :
