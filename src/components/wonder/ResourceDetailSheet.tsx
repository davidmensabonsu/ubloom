        ...
        <div className="space-y-4 pb-6">
          ...
          {bookLinks[resource.id] && (
            <div className="p-4 rounded-2xl bg-muted/50 space-y-2.5">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">{resource.type === 'vitamin' ? 'Where to buy' : resource.type === 'hygiene-tip' ? 'Recommended products' : 'Get this book'}</h4>
