...
import { ThumbsUp, ThumbsDown, TrendingUp, BarChart3, ArrowLeft, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Ubi Quality Dashboard</h1>
            <p className="text-sm text-muted-foreground">Response rating analytics</p>
          </div>
        </div>
