        ...
        >
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              uBloom is a personal wellness and self-growth application operated by [COMPANY NAME], registered at [REGISTERED ADDRESS] ("we", "us", "our"). We are the data controller for all personal data collected through the uBloom application.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              For all data protection inquiries please contact us at [CONTACT EMAIL].
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We process this special category data based on your <strong>explicit consent</strong>, provided when you voluntarily enter this information into the app and agree to this Privacy Policy. You have the right to withdraw this consent at any time by deleting your account or contacting us at [CONTACT EMAIL].
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              For our legitimate interests processing we have assessed that our interests do not override your fundamental rights and freedoms. You have the right to object to legitimate interests processing by contacting us at [CONTACT EMAIL].
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 ml-2">
              ...
              <li><strong>Right to erasure (right to be forgotten)</strong> — You may request deletion of your account and all associated personal data using the Delete Account feature in Profile settings or by contacting us at [CONTACT EMAIL]. We will process deletion within 30 days.</li>
              <li><strong>Right to data portability</strong> — You may request your personal data in a structured, commonly used, machine-readable format. Contact us at [CONTACT EMAIL] to make this request.</li>
              ...
              <li><strong>Right to withdraw consent</strong> — You may withdraw your consent to processing of special category data at any time without affecting the lawfulness of processing before withdrawal. To withdraw consent delete your account or contact us at [CONTACT EMAIL].</li>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              To exercise any of these rights please contact us at [CONTACT EMAIL]. We will respond within 30 days and may need to verify your identity before processing your request.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              If you believe a person under 18 has created an account or provided us with personal data please contact us immediately at [CONTACT EMAIL]. We will immediately suspend the account and permanently delete all associated data.
            </p>
          </section>
