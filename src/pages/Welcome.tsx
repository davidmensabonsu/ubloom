  ...
  return (
    <div className="min-h-screen gradient-background flex flex-col items-center justify-center px-8 relative overflow-hidden">
      ...
      <div className="text-center mb-12">
        <img alt="ubloom logo" className="w-[264px] h-[264px] mx-auto mb-2 drop-shadow-lg saturate-[1.8] brightness-105 contrast-[1.05] rounded-none shadow-none object-cover" src="/lovable-uploads/8d6fe7f1-8318-4452-a115-400fc2532d87.png" />
